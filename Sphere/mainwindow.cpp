...
MainWindow::MainWindow(SceneController* sceneController, int width, int height, QWidget *parent) : QMainWindow(parent)
{
    ...
    connect(controlPanel, &ControlPanel::xRotateChanged, controller, &SceneController::setXrotate);
    connect(controlPanel, &ControlPanel::yRotateChanged, controller, &SceneController::setYrotate);
    connect(controlPanel, &ControlPanel::filtrationChanged, controller, &SceneController::setFiltration);
